...
public class ContratoDAO extends ConexaoDB{
    ...
    private static final String INSERT_CONTRATO_SQL = "INSERT INTO contrato (descricao, data_inicio, data_criacao, id_medidor, id_classe, id_cliente) VALUES (?, ?, ?, ?, ?, ?) ;";
    private static final String SELECT_CONTRATO_BY_ID = "SELECT id, descricao, data_inicio, data_criacao,  id_medidor,  id_classe, id_cliente FROM contrato WHERE id = ?";
    ...
    private static final String UPDATE_CONTRATO_SQL = "UPDATE contrato SET descricao = ?, data_inicio = ?, data_criacao = ?, id_medidor = ?, id_classe = ?, id_cliente = ? WHERE id = ?;";
